...
constexpr auto HASS_DEVICE_STORAGE_NAMESPACE = "HASS_STORAGE";
constexpr auto HASS_DEVICE_STORAGE_KEY_PREFIX = "HASS_DEVICE:%u";
constexpr auto HASS_DEVICE_NUM_KEY = "HASS_DEVICE_NUM";
constexpr auto HOME_BULB_IMG_SRC = "home_bulb";
constexpr auto HOME_FAN_IMG_SRC = "home_fan";
...
//						printf("HassDeviceManager: TaskHassDeviceStateUpdate: light:%s\n", hassDevice.entity_id);
				...
				else if (strcmp(hassDevice.type, "switch") == 0)
				{
					...
					hass_device_info.type = hassDevice.type;
					hass_device_info.friendly_name = hassDevice.friendly_name;
					hass_device_info.img_src = HOME_FAN_IMG_SRC;
					hass_device_info.device_type = DEVICE;
					hass_device_info.is_on_off = true;
					hass_device_info.is_set_value = true;
...
void HassDeviceManager::hass_device_task_create()
{
	printf("HassDeviceManager: hass_device_task_create init hass device task\n");
